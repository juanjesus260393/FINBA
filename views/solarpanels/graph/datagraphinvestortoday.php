...
$query = sprintf("select ifnull(round(sum(m.total_installation),2),0)  total from dbfinba.investor i inner join 
...
where s.school = '" . $_SESSION['Schoolsname'] . "' and m.date_mesure >= '$hora_inicial'  and m.date_mesure <= '$hora_final'");
