...
<div class="modal" id="modalmonitoreo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
            ...
            <div class="modal-body " >
                <div class="row align-content-center text-center">
                    <div class="col-3" >
                        ...
                        <input type="text" id="dos" name="dos" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="tres" name="tres" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="cuatro" name="cuatro"readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="cinco" name="cinco" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="seis" name="seis" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="siete" name="siete" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                        <input type="text" id="ocho" name="ocho" readonly style="border: 0; background-color: #fafafa; outline: none;" required=""/></p>
                                </form>
