<script>
    ...
    function ubicacionFinal(a) {
        ...
        $("#exampleModal").hide();
        $("#school").val(ubicacion[1]);
        $("#building_number").val(ubicacion[2]);
        $("#level").val(ubicacion[3]);
        $("#orientation").val(ubicacion[4]);
        $("#location").val(ubicacion[5]);
        $("#reference").val(ubicacion[6]);
        $("#registry_number").val(ubicacion[7]);
    }
    ;
    function getinfo(a) {
...
?>
                        ...
                        <map name="levelsCic"> 
                            ...
                            <area id="CICN3" shape="rect" coords="175,15,835,150" alt="Venus" nohref onclick="settoN3();
                                    return false;">
                        </map> 
                        ...
                        <map name="edificiosEscom">
                            ...
                            <area id="Edificio 5" shape="rect" coords="456,247,623,506" alt="Venus" nohref onclick="settoE5();
                                    return false;">


                        </map>
                        <map name="levelsEscomE1"> 
                            <area id="ESCOM2" shape="rect" coords="175,305,835,440" alt="Venus" nohref onclick="settoN2E1ESCOM();
                                    return false;">
